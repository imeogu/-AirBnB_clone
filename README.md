...
()
```
5. This prompt designates you are in the "" console. There are a variety of commands available within the console program.
...
```
() show BaseModel 3aa5babc-efb6-4041-bfe9-3cc9727588f8
...
```
() destroy BaseModel 3aa5babc-efb6-4041-bfe9-3cc9727588f8
() show BaseModel 3aa5babc-efb6-4041-bfe9-3cc9727588f8
** no instance found **
()   
```
...
```
() update BaseModel b405fc64-9724-498f-b405-e4071c3d857f first_name "person"
() show BaseModel b405fc64-9724-498f-b405-e4071c3d857f
...
```
() User.update("98bea5de-9cb0-4d78-8a9d-c4de03521c30", name "Todd the Toad")
()
() User.all()
